...
const Login = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <img
        src="/currency.png"
        className={styles.containerhack__image}
        style={stage >= 2 ? { transform: "translate(-100%)" } : {}}
      />
      <img
        src="/intro.png"
        className={styles.containerhack__image}
        style={stage >= 3 ? { transform: "translate(-100%)" } : {}}
      />
      <div className={styles.container__login}>
        <div className={styles.container__login__dots}>
          <div
            className={styles.container__login__dots__dot}
            style={
              stage == 1
                ? {
                    width: "32px",
                    borderRadius: "50px",
                    backgroundColor: "#D486B8",
                  }
                : {}
            }
          ></div>
        ...
        <div
          ...
          ref={loginRef}
        >
          <h1 className={styles.container__login__heading}>
            Welcome to nuxEland!
          </h1>
          <span className={styles.container__login__what}>
            WHAT IS NUXELAND?
          </span>
          <span className={styles.container__login__desc}>
            nuxEland is your very own fantasy world. Limited by your own
            creativity, you are free to write your own story!
            <br />
            <div style={{ height: "12px" }}></div>
            That being said, as a human, you may encounter some challenges on
            your journey, but worry not, as this app will help you all the way
            through!
          </span>

          <div style={{ height: "24px" }}></div>
          <span className={styles.container__login__tut}>
            This tutorial will give you a brief overview of nuxEland and how
            this app can help you navigate safely.
          </span>
          <button
        ...
        <div
          className={styles.containerhack__div}
          style={
            stage >= 2
              ? { transform: "translate(-100vw)", height: height }
              : { height: height }
          }
        >
          <h1
            className={styles.container__login__heading}
            style={{ color: "#5BBB5F" }}
          >
            Currency
          </h1>
          ...
          <button
            ...
            style={{
              color: "#359939",
              backgroundColor: "rgba(53, 153, 57, 0.25)",
            }}
            onClick={() => {
              setStage(stage + 1);
            }}
        ...
        >
          ...
          <span className={styles.container__login__what}>LANGUAGES</span>
          <span className={styles.container__login__desc}>
            ...
            languages and English, so as to help travellers communicate easily.
            <br />
            <div style={{ height: "24px" }}></div>
            <div className={styles.container__login__tut}>
          ...
          >
            <button
              ...
              style={{
                color: "#348CB4",
                backgroundColor: "rgba(52, 140, 180, 0.20)",
              }}
              onClick={() => {
                setStage(stage + 1);
              }}
